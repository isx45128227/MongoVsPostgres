...
09/05/2018 | Cerca informació logs Postgres i Mongo. Documentació general Postgres i Mongo.  | Comprovació de dades errònies a mongo. Generació de scripts en bash per fer connexions massives al servidor de Postgres i Mongo. Canvis en el fitxer de configuració de Postgres per poder registrar els logs.  | 4 hores. 
